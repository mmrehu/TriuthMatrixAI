<!-- Footer - BILKUL WAHI JAISA TUMHARA THA -->
<footer class="footer">
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <p class="footer-description">
                    Protecting truth in the digital age with advanced AI-powered deepfake and fake news detection.
                </p>
                <div class="social-links">
                    <a href="#" class="social-link glass">
                    ...
                    <a href="contact.php" class="social-link glass">
...
<script>
    // Mobile Menu Toggle - Same as yours
